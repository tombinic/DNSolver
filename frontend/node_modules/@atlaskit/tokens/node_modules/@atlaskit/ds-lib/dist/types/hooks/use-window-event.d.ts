 ...
 */
export default function useWindowEvent<TEventName extends keyof WindowEventMap>(eventName: TEventName, callback: (this: Window, ev: WindowEventMap[TEventName]) => void, options?: boolean | AddEventListenerOptions): void;
